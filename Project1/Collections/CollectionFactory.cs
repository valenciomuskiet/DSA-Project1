...
/// <summary>
/// Geeft de juiste IMyCollection-implementatie terug op basis van de keuze van de gebruiker.
/// Alle vier de data structures implementeren dezelfde interface, zodat de rest van de applicatie
/// er niets van merkt welke gekozen is.
/// </summary>
public static class CollectionFactory
{
    ...
    /// <summary>
    /// Vraagt de gebruiker welke data structure hij/zij wil gebruiken en geeft die terug.
    /// </summary>
    ...
    /// <summary>
    /// Maakt een lege IMyCollection aan van het gekozen type.
    /// Zodra LinkedList, BST en HashMap geïmplementeerd zijn, worden de cases hier ingevuld.
    /// </summary>
    public static IMyCollection<T> Create<T>(CollectionType type) where T : IEquatable<T>
    {
        return type switch
        {
            ...
            CollectionType.LinkedList     => new GenericArray<T>(), // vervangen in stap 2
    ...
    /// <summary>
    /// Geeft een leesbare naam terug van het gekozen type (voor in de UI).
    /// </summary>
